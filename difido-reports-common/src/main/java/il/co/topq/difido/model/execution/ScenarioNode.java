...
public class ScenarioNode extends NodeWithChildren<Node> {
	...
	@JsonIgnore
	private AtomicLong testWaveDuration = new AtomicLong();
	/**
	 * Copy constructor
	 * 
	 * @param aScenarioNode
	...
	public AtomicLong getTestWaveDuration() {
		return testWaveDuration;
	}

	public void setTestWaveDuration(long addTimePeriod) {
		this.testWaveDuration.addAndGet(addTimePeriod);
	}
